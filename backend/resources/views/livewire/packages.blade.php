<div>
    <header class="mb-8 flex items-center justify-between">
        <div>
            <p class="text-sm uppercase tracking-[0.2em] text-cyan-300">Packages</p>
            <h1 class="mt-2 text-3xl font-black text-white">Manage Packages & IPs</h1>
        </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
            ...
            <div class="relative w-full max-w-lg rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-2xl">
                <div class="mb-6 flex items-center justify-between">
                    <h3 class="text-2xl font-bold text-white">{{ $isEditing ? 'Edit Package' : 'Create Package' }}</h3>
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div class="mt-8 flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" class="rounded-xl bg-cyan-500 px-6 py-2 font-medium text-slate-950 transition hover:bg-cyan-400">Save Package</button>
                    </div>
                </form>
            </div>
        </div>

            ...
            <div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
                ...
                <header class="sticky top-0 z-50 flex w-full border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                        ...
                        <div class="w-full items-center justify-between gap-4 px-5 py-3 lg:flex lg:justify-end lg:px-0 lg:py-4">
                            @php
                            ...
                            <!-- Dark mode toggler -->
                            <button type="button" @click="toggleDark()" aria-label="Toggle dark mode" class="flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
                            ...
                            <div class="relative" @click.outside="userMenuOpen = false">
                                ...
                                <div x-show="userMenuOpen" x-transition class="shadow-theme-lg absolute right-0 mt-3 flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-gray-dark">
